...
for epoch in range(epochs):
    ...
    if epoch_val_loss < best_val_loss:
        ...
        torch.save(model_base.state_dict(), 'best_breast_mnist_model_resnet.pth')
        print(" -> Best model saved!")

"""Load best model and have a validation on test set"""

model_base.load_state_dict(torch.load('best_breast_mnist_model_resnet.pth'))
...
print(f'Test Accuracy (Best model_base): {test_acc:.4f}')
...
get_clinical_report(model_base, final_test_loader, device)
